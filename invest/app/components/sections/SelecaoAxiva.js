...
const selectionItems = [
    { ticker: 'ITUB4', name: 'Itaú Unibanco', quality: 5, discount: '-9,8%', criteria: 'Qualidade + Valuation' },
    { ticker: 'WEGE3', name: 'WEG Equipamentos', quality: 5, discount: '+12,3%', criteria: 'Qualidade + Crescimento' },
    { ticker: 'PETR4', name: 'Petrobras PN', quality: 4, discount: '-8,7%', criteria: 'Valuation + DY' },
    { ticker: 'VALE3', name: 'Vale ON', quality: 4, discount: '+5,7%', criteria: 'Qualidade + Valuation' },
];
        ...
        React.createElement("div", { className: "mx-auto max-w-container px-4 lg:px-8" },
            React.createElement("div", { className: "grid items-center gap-12 lg:grid-cols-2 lg:gap-16" },
                ...
                React.createElement("div", null,
                    React.createElement(BrowserFrame, { url: "axivainvest.com.br/selecao" },
                        React.createElement("div", { className: "p-5 sm:p-6" },
                            ...
                            React.createElement("div", { className: "flex flex-col gap-2" }, selectionItems.map((item) => (React.createElement("div", { key: item.ticker, className: "flex items-center justify-between rounded-lg border border-slate-200 px-4 py-3 transition-colors hover:border-axiva-green/30 hover:bg-axiva-green-soft/30" },
                                ...
                                React.createElement("div", { className: "flex items-center gap-4" },
                                    ...
                                    React.createElement("span", { className: `text-sm font-medium ${item.discount.startsWith('-') ? 'text-axiva-green' : 'text-red-500'}` }, item.discount)))))))))))));
}
