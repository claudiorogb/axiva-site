                    ...
                    React.createElement("div", { className: "p-5 sm:p-6" },
                        React.createElement("div", { className: "mb-4 flex items-center justify-between" },
                            ...
                            React.createElement("span", { className: "text-xs text-slate-400" },
                                items.length,
                                " empresas")),
                        React.createElement("div", { className: "flex flex-col gap-1.5" }, items.map((item) => (React.createElement("div", { key: item.ticker, className: "flex items-center justify-between rounded-lg border border-slate-200 px-4 py-2" },
                            React.createElement("div", { className: "flex items-center gap-2 min-w-0" },
                                React.createElement("span", { className: "text-sm font-semibold text-axiva-navy" }, item.ticker),
                                React.createElement("span", { className: "truncate text-[11px] text-slate-400" }, item.name)),
                        ...
                        React.createElement("div", { className: "mt-3 rounded-lg border border-axiva-green/20 bg-axiva-green-soft/30 p-3" },
                            React.createElement("div", { className: "flex items-center gap-2" },
                            ...
                            React.createElement("p", { className: "mt-1 text-[11px] leading-4 text-axiva-gray" }, "3 alertas configurados para mudanças de preço, indicadores e critérios."))))))));
}
