...
export default function BrowserFrame({ children, url = 'axivainvest.com.br', className = '', showChrome = true }) {
    return (React.createElement("div", { className: `overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm ${className}` },
        showChrome && (React.createElement("div", { className: "flex items-center gap-2 border-b border-slate-200 bg-slate-50 px-4 py-3" },
